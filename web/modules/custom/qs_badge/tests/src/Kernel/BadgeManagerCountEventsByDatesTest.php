 ...
 */
class BadgeManagerCountEventsByDatesTest extends ResoliKernelTestBase {
  ...
  public function testCountEventsByDatesDontMixCommunities() {
    ...
    $event = $this->entityTypeManager->getStorage('node')->create([
      ...
      'field_start_at' => '2016-08-30T09:00:00',
      'field_end_at' => '2016-08-30T09:30:00',
    ]);
    $event->save();
  ...
  public function testCountEventsByDates() {
    ...
    $event = $this->entityTypeManager->getStorage('node')->create([
      ...
      'title' => $this->randomString(),
      'field_activity' => $activities[1]->id(),
      'field_start_at' => '2014-09-28T12:00:00',
      'field_end_at' => '2014-09-28T16:30:00',
    ]);
    $event->save();
    ...
    $event = $this->entityTypeManager->getStorage('node')->create([
      ...
      'title' => $this->randomString(),
      'field_activity' => $activities[1]->id(),
      'field_start_at' => '2019-08-28T09:00:00',
      'field_end_at' => '2019-08-28T09:30:00',
    ]);
    $event->save();
