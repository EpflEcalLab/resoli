Feature: Badges - Privilege - My Photos
  Asserts the listing of My Photos show badges
  ...
  @api
  Scenario: Logged as Member of Lausanne & Organizer of Fribourg, I should see no badges 'casue I have 0 activity where I can upload photos.
