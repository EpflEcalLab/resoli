...
## Element listed
  ...
  Scenario: Logged as Member of Lausanne & Organizer of Fribourg, When I access "My offers" in Lausanne
    ...
    Then I should see 1 "#offers-accordion .card-list-item#card75 .card-pill-deactivated" element
...
## Visible actions per element listed
  Scenario: Logged as Member of Lausanne & Organizer of Fribourg, When I access "My offers" in Lausanne
    ...
    Then I should see 1 "#offers-accordion .card-list-item#card72 .card-actions form.deactivate" element
    ...
    Then I should see 1 "#offers-accordion .card-list-item#card71 .card-actions form.deactivate" element
    ...
    Then I should see 1 "#offers-accordion .card-list-item#card75 .card-actions form.delete" element
    Then I should see 1 "#offers-accordion .card-list-item#card75 .card-actions form.reactivate" element
