...
/**
 * Collection of Accounts waiting for Approval by Community.
 *
 * @Block(
 *   id = "qs_community_waiting_approval_collection_block",
 *   admin_label = @Translation("Collection of Accounts waiting for Approval by Community"),
 * )
 */
class WaitingApprovalCollectionBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build($params = []) {
    ...
    return [
      '#theme'     => 'qs_community_waiting_approval_collection_block',
      '#variables' => $variables,
      '#cache' => [
        'contexts' => [
          'user',
