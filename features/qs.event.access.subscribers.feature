Feature: Event Dashboard Subscribers
...
## Dashboard Subscribers
  @api
  Scenario: Logged as Manager of Lausanne, I can access to the Dashboard subscribers of Event 16, because I'm the organizer of this activity
  ...
  @api
  Scenario: Logged as Manager of Lausanne, I can't access to the Dashboard subscribers of Event 35, because I'm one of the maintainers of this activity
    Given I am logged in as user "manager+lausanne"
    When I am on "/lausanne/activities/activity-3-lausanne-theme-ndeg1/events/event-activity-3-2-days-16h00/dashboard/subscribers"
    And the response status code should be 200

  @api
  Scenario: Logged as Manager of Lausanne, I can't access to the Dashboard subscribers of Activity N°5 (Activity 5 - Lausanne - Theme N°1) because I have no provilege on this activity
    Given I am logged in as user "manager+lausanne"
    When I am on "/lausanne/activities/activity-5-lausanne-theme-ndeg1/events/event-activity-5-10-days-ago-23h20/dashboard/subscribers"
    And the response status code should be 403

  @api
  Scenario: Logged as Organizer of Lausanne, I can access to the Dashboard subscribers of Event 35, because I'm the organizer of this activity
    Given I am logged in as user "organizer+lausanne"
    When I am on "/lausanne/activities/activity-3-lausanne-theme-ndeg1/events/event-activity-3-2-days-16h00/dashboard/subscribers"
    And the response status code should be 200

  @api
  Scenario: Logged as Member of Lausanne, I can't access to the Dashboard subscribers of Event 35, because I'm not an organizer of this activity
    Given I am logged in as user "member+lausanne"
    When I am on "/lausanne/activities/activity-3-lausanne-theme-ndeg1/events/event-activity-3-2-days-16h00/dashboard/subscribers"
    And the response status code should be 403

  @api
  Scenario: Logged as Member of Lausanne, I can't access to the Dashboard subscribers of Event 16, even If I'm member of this activity because, I'm not an organizer of this activity
    Given I am logged in as user "member+lausanne"
    When I am on "/lausanne/activities/activity-2-lausanne-theme-ndeg1/events/event-activity-2-1-day-ago-15h00/dashboard/subscribers"
    And the response status code should be 403
  ...
  @api
  Scenario: Logged as Member of Fribourg, I can't access to the Dashboard subscribers of Event 16, because I have no provilege on this activity
    Given I am logged in as user "member+fribourg"
    When I am on "/lausanne/activities/activity-2-lausanne-theme-ndeg1/events/event-activity-2-1-day-ago-15h00/dashboard/subscribers"
    And the response status code should be 403

  @api
  Scenario: Logged as approval of Lausanne, I can't access to the Dashboard subscribers of Event 16, because I have no provilege on this activity
