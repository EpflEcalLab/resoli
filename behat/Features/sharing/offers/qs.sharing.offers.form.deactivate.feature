...
## Access
  @api
  Scenario Outline: Logged-in, I can access my own offers deactivate forms. Accessing other people offers deactivate form page should be unauthorized.
    Given I am logged in as user "<user>"
    When I am on "/sharing/<offer-id>/deactivate"
...
## Form submits.
  ...
  Scenario: When deactivating an Offer, it should works and redirect me on my offer dashboard page
    ...
    And I should see "qs_sharing.offers.form.deactivate.success Transports et déplacements" in the ".alert" element
