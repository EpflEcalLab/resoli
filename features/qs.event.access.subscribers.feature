...
## Dashboard Subscribers
  ...
  Scenario: Logged as Manager of Lausanne, I can't access to the Dashboard subscribers of Event 35, because I'm one of the maintainers of this activity
    Given I am logged in as user "manager+lausanne"
    When I am on "/lausanne/activities/sorties-theatre/events/un-obus-dans-le-coeur/dashboard/subscribers"
    And the response status code should be 200

  @api
  Scenario: Logged as Manager of Lausanne, I can't access to the Dashboard subscribers of Activity N°5 (Activity 5 - Lausanne - Theme N°1) because I have no privilege on this activity
    Given I am logged in as user "manager+lausanne"
    When I am on "/lausanne/activities/accueil-cafe/events/accueil-cafe/dashboard/subscribers"
  ...
  @api
  Scenario: Logged as Member of Fribourg, I can't access to the Dashboard subscribers of Event 16, because I have no privilege on this activity
    Given I am logged in as user "member+fribourg"
    When I am on "/lausanne/activities/atelier-creatif/events/atelier-scooby-doo/dashboard/subscribers"
    And the response status code should be 403

  @api
  Scenario: Logged as approval of Lausanne, I can't access to the Dashboard subscribers of Event 16, because I have no privilege on this activity
