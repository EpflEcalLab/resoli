Feature: Badges - Subscription - Calendar - List
  ...
  @api
  Scenario: Logged as Member N°2 of Fribourg, when reaching the Calendar Weekly, I should see my 1 badge of subscriptions. I see my Confirmed/Organizer badge.
  ...
  @api
  Scenario: Logged as Member N°2 of Fribourg, when reaching the Calendar Monthly, I should see my 1 badge of subscriptions. I see my Confirmed/Organizer badge.
  Given I am logged in as user "member2+fribourg"
  When I am on "/fribourg/calendar/monthly"
  And the response status code should be 200
  Then I should see 1 ".calendar-item .flag" elements
  ...
  @api
  Scenario: Logged as Member & Organizer of Fribourg, when reaching the Calendar Weekly I should see 0 badges 'cause I have 0 subscriptions in Fribourg community - I'm only an Organizer.
  ...
  @api
  Scenario: Logged as Member & Organizer of Fribourg, when reaching the Calendar Monthly I should see 0 badges 'cause I have 0 subscriptions in Lausanne community - I'm only an Organizer.
  Given I am logged in as user "member+fribourg+organizer+fribourg"
  When I am on "/fribourg/calendar/monthly"
  And the response status code should be 200
  Then I should see 0 ".calendar-item .flag" elements
