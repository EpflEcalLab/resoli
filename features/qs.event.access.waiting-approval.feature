...
## Dashboard Waiting Approval
  ...
  Scenario: Logged as Manager of Lausanne, I can't access to the Dashboard waiting Approval of Event 35, because I'm one of the maintainers of this activity
    Given I am logged in as user "manager+lausanne"
    When I am on "/lausanne/activities/activity-3-lausanne-theme-ndeg1/events/event-activity-3-2-days-16h00/dashboard/waiting-approval"
    And the response status code should be 200

  @api
  Scenario: Logged as Manager of Lausanne, I can't access to the Dashboard waiting Approval of Activity N°5 (Activity 5 - Lausanne - Theme N°1) because I have no provilege on this activity
    Given I am logged in as user "manager+lausanne"
    When I am on "/lausanne/activities/activity-5-lausanne-theme-ndeg1/events/event-activity-5-10-days-ago-23h20/dashboard/waiting-approval"
  ...
  @api
  Scenario: Logged as Member of Fribourg, I can't access to the Dashboard waiting Approval of Event 16, because I have no provilege on this activity
    Given I am logged in as user "member+fribourg"
    When I am on "/lausanne/activities/activity-2-lausanne-theme-ndeg1/events/event-activity-2-1-day-ago-15h00/dashboard/waiting-approval"
    And the response status code should be 403

  @api
  Scenario: Logged as approval of Lausanne, I can't access to the Dashboard waiting Approval of Event 16, because I have no provilege on this activity
