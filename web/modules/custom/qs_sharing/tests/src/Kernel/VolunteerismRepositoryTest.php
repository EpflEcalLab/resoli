...
final class VolunteerismRepositoryTest extends KernelTestBase {
  ...
  /**
   * @covers ::getAllByCommunityTheme
   */
  public function testGetAllByCommunityThemeReturnsExpected(): void {
    ...
    $volunteerisms = $this->volunteerismRepository->getAllByCommunityTheme($community2, $theme1);
    self::assertCount(1, $volunteerisms);
