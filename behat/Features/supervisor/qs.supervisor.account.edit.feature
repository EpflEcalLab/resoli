Feature: Account Edit
  ...
  Scenario: When I edit my account, the value should remaing in the database
    ...
    And I should see "qs_supervisor.account.form.edit.success Firstname (edited), Lastname (edited), behat@antistatique.net" in the ".alert" element
    Then I am on "/account/1/edit"
    And the "edit-mail" field should contain "behat@antistatique.net"
